...
class NovelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create novel" do
    assert_difference('Novel.count') do
      post novels_url, params: { novel: { description: @novel.description, like: @novel.like, osusume_id: @novel.osusume_id, title: @novel.title, url: @novel.url } }
    end
  ...
  test "should update novel" do
    patch novel_url(@novel), params: { novel: { description: @novel.description, like: @novel.like, osusume_id: @novel.osusume_id, title: @novel.title, url: @novel.url } }
